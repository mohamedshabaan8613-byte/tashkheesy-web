...
export default function Contact() {
  useSEO({
    ...
    description: "تواصل مع فريق تشخيصي لأي استفسار عن خدمات تشخيص صعوبات التعلم. نرد خلال 24 ساعة.",
    keywords: "تواصل تشخيصي, استفسار صعوبات تعلم, دعم تشخيصي, بريد تشخيصي",
    canonical: "/contact",
  });
  return (
