...
import type { SpecialistRecommendation } from "./consultationBookingTypes";
...
export interface AssessmentResultPayload {
  ...
  /**
   * مستوى الخطورة كـ string للعرض — اختياري.
   */
  severityLevel?: string;
  /**
   * ملخص نتائج التقييم للعرض — اختياري.
   */
  summary?: string;
}
...
export interface ConsultationIntent {
   ...
   */
  /**
   * معرّف فريد للنية — يُستخدم كـ sourceIntentId في booking session.
   * اختياري للتوافق مع النيات القديمة المخزنة في sessionStorage.
   */
  intentId?: string;
  /**
   * معرّف جلسة التقييم — يُستخدم في AssessmentBookingInput.
   * اختياري: موجود فقط عند entryPoint === "assessment_result".
   */
  assessmentSessionId?: string;
  /**
   * توصية الأخصائي من نتائج التقييم — اختياري.
   */
