...
export const CONSULTATION_ROUTES = {
  ...
  /** صفحة اختيار الأخصائي — Sprint 3.2 */
  BOOKING_SPECIALISTS: "/consultation/booking/specialists",

  /** صفحة اختيار الموعد — Sprint 3.2 */
  BOOKING_SLOTS: "/consultation/booking/slots",

  /**
   * صفحة تأكيد الحجز — نهاية الـ funnel.
   * Sprint 3.3: تُعرض بعد نجاح orchestrator confirmation.
   */
