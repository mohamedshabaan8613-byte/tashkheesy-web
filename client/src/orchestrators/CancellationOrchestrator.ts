...
import { isValidTransition } from "../types/consultationBookingTypes";
...
const CANCELLABLE_PHASES: import("../types/consultationBookingTypes").BookingPhase[] = [
  "CREATED", "SPECIALIST_SELECTION", "SLOT_SELECTION", "REVIEW",
];
  ...
  if (reservationId && supabase) {
    try {
      const { error: releaseError } = await supabase
        ...
        // @ts-expect-error Supabase table type not configured
