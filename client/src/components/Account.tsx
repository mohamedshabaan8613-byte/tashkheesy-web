/**
 * Account.tsx — Sprint 1A
 * Route: /account
 *
 * Shows logged-in user info and quick links.
      ...
      >
        ...
        <div className="px-8 py-6">
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              <FolderOpen size={18} className="text-blue-600 flex-shrink-0" />
              ملفات أطفالي
            </a>
            <a
              href="/start"
              ...
              style={{ fontFamily: "'Cairo', sans-serif" }}
            >
              <PlayCircle size={18} className="text-teal-600 flex-shrink-0" />
              ابدأ فحصًا جديدًا
            </a>
          </div>
