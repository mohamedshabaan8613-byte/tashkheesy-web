...
const steps = [
  {
    ...
    desc: "فحص منظم يستغرق أقل من ١٥ دقيقة، يُغطي مؤشرات القراءة والكتابة والانتباه والتركيز.",
  ...
  },
  {
    ...
    desc: "يُحلّل الذكاء الاصطناعي إجاباتك فورياً ويُنشئ شرحاً أولياً بالعربية — يساعدك على فهم المؤشرات بوضوح.",
  ...
  },
  {
    ...
    desc: "بناءً على نتائج الفحص، نوجّهك نحو الخطوة الأنسب — سواء كانت حجز مع متخصص أو استشارة متخصصة.",
