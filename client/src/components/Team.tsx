...
export default function Team() {
  useSEO({
    title: "فريق أخصائيي تشخيص صعوبات التعلم",
    description: "تعرّف على فريق تشخيصي من أخصائيي صعوبات التعلم والقراءة المعتمدين في المملكة العربية السعودية. خبرة تتجاوز 10 سنوات في التشخيص التربوي.",
    keywords: "أخصائي صعوبات تعلم, أخصائي ديسلكسيا السعودية, فريق تشخيص تربوي, أخصائي تشخيص نفسي",
    canonical: "/team",
  });
  const team = [
    {
