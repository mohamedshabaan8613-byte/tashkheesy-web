...
const stats = [
  { value: "١ من كل ٥", label: "أطفال يعانون من صعوبة تعلم ما" },
  { value: "+٣ سنوات", label: "متوسط التأخر في الحصول على الدعم" },
  { value: "٨٠٪", label: "من الحالات تتحسن مع الدعم المبكر" },
  { value: "عربي ١٠٠٪", label: "محتوى مصمم لمجتمعنا" },
];
