    ...
    <section className="py-20 bg-slate-50">
      <div className="container">
        <div className="text-center mb-16">
          <div className="inline-block px-4 py-1.5 mb-4 text-sm font-bold tracking-wider text-[#1E4E8C] uppercase bg-[#DFF3F1] rounded-full">
            باقاتنا وأسعارنا
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {packages.map((pkg, index) => (
            ...
            >
              {pkg.highlighted && (
                <div className="absolute -top-5 left-1/2 -translate-x-1/2 bg-[#1E4E8C] text-white text-sm font-bold px-6 py-1.5 rounded-full flex items-center gap-2 shadow-lg">
                ...
                <Link href="/booking">
                  <Button
                    className={`w-full h-12 text-lg font-bold ${
                      pkg.highlighted 
                        ? "bg-[#1E4E8C] hover:bg-[#1A3F73] shadow-lg shadow-indigo-200" 
                        : "bg-white text-[#1E4E8C] border-2 border-indigo-600 hover:bg-[#DFF3F1]"
                    }`}
                  >
                    {pkg.cta}
                  </Button>
        ...
        <div className="mt-16 text-center">
          <p className="text-slate-500 text-sm">
            ...
            <Link href="/services" className="text-[#1E4E8C] font-bold mr-1 hover:underline">تواصل معنا هنا</Link>
          </p>
        </div>
      </div>
    </section>
