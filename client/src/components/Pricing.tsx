...
export default function Pricing() {
  useSEO({
    title: "أسعار تشخيص صعوبات التعلم والديسلكسيا",
    description: "اطلع على أسعار خدمات تشخيصي: باقة تشخيص الأطفال بـ 299 ر.س وباقة طلاب الجامعة بـ 349 ر.س. شامل تقرير رسمي PDF وجلسة متابعة.",
